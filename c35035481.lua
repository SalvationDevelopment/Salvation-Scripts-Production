...
function c35035481.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,35035481,0,0x11,2,1200,0,RACE_AQUA,ATTRIBUTE_WATER) end
...
function c35035481.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e)
		and Duel.IsPlayerCanSpecialSummonMonster(tp,35035481,0,0x11,2,1200,0,RACE_AQUA,ATTRIBUTE_WATER) then
