--Amorphage Infection
--By: HelixReactor
function c72001831.initial_effect(c)
	--Activate
...
function c72001831.stg(e,c)
	return c:IsSetCard(0x1d1) 
end
function c72001831.stfilter(c)
...
function c72001831.thcon(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c72001831.confilter,1,nil,tp)
end
function c72001831.thfilter(c)
	return c:IsSetCard(0x1d1) and c:IsAbleToHand()
end
function c72001831.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c72001831.thfilter,tp,LOCATION_DECK,0,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK)
end
function c72001831.thop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g=Duel.SelectMatchingCard(tp,c72001831.thfilter,tp,LOCATION_DECK,0,1,1,nil)
