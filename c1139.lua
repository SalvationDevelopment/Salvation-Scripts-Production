...
function c1139.initial_effect(c)
	--Activate
	...
	e1:SetCost(c1139.cost)
	e1:SetTarget(c1139.target)
	e1:SetOperation(c1139.activate)
	c:RegisterEffect(e1)
end
function c1139.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c1139.sumlimit(e,c,sump,sumtype,sumpos,targetp,se)
	return e:GetLabelObject()~=se
end
function c1139.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c1139.activate(e,tp,eg,ep,ev,re,r,rp)
