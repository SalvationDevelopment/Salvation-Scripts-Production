...
function c1229.initial_effect(c)
	...
	e1:SetCondition(c1229.condition)
	e1:SetTarget(c1229.target)
	e1:SetOperation(c1229.activate)
	c:RegisterEffect(e1)
end
function c1229.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c1229.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetTargetCard(re:GetHandler())
	Duel.SetOperationInfo(0,CATEGORY_DISABLE,eg,1,0,0)
end
function c1229.activate(e,tp,eg,ep,ev,re,r,rp)
