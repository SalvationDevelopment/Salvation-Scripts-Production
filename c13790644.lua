...
function c13790644.regtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	and Duel.IsExistingTarget(c13790644.stfilter,tp,0,LOCATION_MZONE,1,atk) end
...
function c13790644.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and Duel.SendtoHand(tc,nil,REASON_EFFECT) then
		local dg=Duel.GetMatchingGroup(c13790644.stfilter,tp,0,LOCATION_MZONE,atk)
		if dg:GetCount()>0 then
			Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_DESTROY)
			local g=Duel.SelectMatchingCard(tp,c13790644.stfilter,tp,0,LOCATION_MZONE,1,1,atk)
