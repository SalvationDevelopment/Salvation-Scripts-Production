...
function c13790624.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(13790624,0))
...
function c13790624.negop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.SelectYesNo(tp,aux.Stringid(13790624,3)) then
		e:GetHandler():RegisterFlagEffect(13790624,RESET_EVENT+0x1fe0000+RESET_PHASE+PHASE_END,0,1)
