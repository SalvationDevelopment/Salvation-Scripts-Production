...
function c79234734.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(79234734,0))
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetRange(LOCATION_MZONE)
	e1:SetCountLimit(1,79234734)
	e1:SetCost(c79234734.chcost)
	e1:SetOperation(c79234734.chop)
	c:RegisterEffect(e1)
	--to hand
...
function c79234734.chcost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c79234734.chop(e,tp,eg,ep,ev,re,r,rp)
...
function c79234734.thfilter(c)
	return (c:IsCode(32013448) or c:IsCode(6628343)) and c:IsAbleToHand()
end
