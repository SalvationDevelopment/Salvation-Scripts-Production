...
function c16006416.initial_effect(c)
	...
	e3:SetCountLimit(1)
	e3:SetCondition(c16006416.discon)
	e3:SetTarget(c16006416.distg)
	e3:SetOperation(c16006416.disop)
	c:RegisterEffect(e3)
end
...
function c16006416.discon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer()==tp and re:IsActiveType(TYPE_SPELL+TYPE_TRAP) and Duel.IsChainNegatable(ev)
end
function c16006416.distg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetOperationInfo(0,CATEGORY_DISABLE,eg,1,0,0)
end
function c16006416.disop(e,tp,eg,ep,ev,re,r,rp)
