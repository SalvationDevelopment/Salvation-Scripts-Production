...
function c1184.initial_effect(c)
	...
	e1:SetCondition(c1184.condition)
	e1:SetOperation(c1184.activate)
	c:RegisterEffect(e1)
end
function c1184.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c1184.distg(e,c)
	return c~=e:GetHandler()
end
function c1184.disop(e,tp,eg,ep,ev,re,r,rp)
