...
function c100911039.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
	aux.AddFusionProcFun2(c,c100911039.ffilter,aux.FilterBoolFunction(Card.IsRace,RACE_WARRIOR),true)
	--atk
	...
	e2:SetCondition(c100911039.discon)
	e2:SetOperation(c100911039.disop)
	c:RegisterEffect(e2)
	--remove
