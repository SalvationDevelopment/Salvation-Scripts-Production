...
function c53262004.tdfilter(c)
	return c:IsType(TYPE_PENDULUM) and c:IsFaceup() and c:IsAbleToDeck()
end
function c53262004.distg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c53262004.tdfilter,tp,LOCATION_EXTRA,0,1,nil) end
...
function c53262004.disop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c53262004.tdfilter,tp,LOCATION_EXTRA,0,1,1,nil)
