...
function c65338781.initial_effect(c)
	...
	e1:SetOperation(c65338781.acop)
	c:RegisterEffect(e1)
	--special summon
	...
	e2:SetCost(c65338781.spcost)
	e2:SetTarget(c65338781.sptg)
	e2:SetOperation(c65338781.spop)
	c:RegisterEffect(e2)
	--counter
	...
	e3:SetCost(c65338781.ctcost)
	e3:SetTarget(c65338781.cttg)
	e3:SetOperation(c65338781.ctop)
	c:RegisterEffect(e3)
end
