...
function c13790599.initial_effect(c)
	...
	e1:SetCondition(c13790599.spcon)
	c:RegisterEffect(e1)
	--damage reduce
	local e1=Effect.CreateEffect(c)
	...
	e1:SetCondition(c13790599.condition)
	e1:SetOperation(c13790599.operation)
	c:RegisterEffect(e1)
	...
	e3:SetCondition(c13790599.valcon)
	e3:SetValue(3300)
	c:RegisterEffect(e3)
	local e4=e3:Clone()
...
function c13790599.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetLabel(cid)
	e1:SetValue(c13790599.refcon)
	e1:SetReset(RESET_CHAIN)
	Duel.RegisterEffect(e1,tp)
end
function c13790599.refcon(e,re,val,r,rp,rc)
