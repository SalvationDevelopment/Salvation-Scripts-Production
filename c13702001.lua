...
function c13702001.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(13702001,0))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e1:SetProperty(EFFECT_FLAG_DAMAGE_STEP+EFFECT_FLAG_DELAY)
	e1:SetCode(EVENT_TO_GRAVE)
	e1:SetRange(LOCATION_HAND)
	e1:SetCondition(c13702001.spcon)
	e1:SetTarget(c13702001.sptg)
	e1:SetOperation(c13702001.spop)
	c:RegisterEffect(e1)
	--extra summon
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringid(13702001,1))
...
function c13702001.spcon(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c13702001.cfilter,1,nil,tp)
end
function c13702001.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
