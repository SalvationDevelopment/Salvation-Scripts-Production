--Fusion Tag
function c80001066.initial_effect(c)
	--Activate
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e1:SetTarget(c80001066.costarget)
	e1:SetOperation(c80001066.cosoperation)
	c:RegisterEffect(e1)
end

function c80001066.costarget(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c80001066.cosoperation(e,tp,eg,ep,ev,re,r,rp)
