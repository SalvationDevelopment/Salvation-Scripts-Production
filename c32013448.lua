...
function c32013448.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(32013448,2))
	e1:SetCategory(CATEGORY_TOHAND+CATEGORY_SEARCH)
	e1:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e1:SetCode(EVENT_REMOVE)
	e1:SetProperty(EFFECT_FLAG_DAMAGE_STEP+EFFECT_FLAG_DELAY)
	e1:SetCountLimit(1,32013448)
	e1:SetCondition(c32013448.thcon)
	e1:SetTarget(c32013448.thtg)
	e1:SetOperation(c32013448.thop)
	c:RegisterEffect(e1)
	--Become material
	...
	e2:SetCondition(c32013448.condition)
	e2:SetOperation(c32013448.operation)
	c:RegisterEffect(e2)
end

function c32013448.cfilter(c,e,tp)
...
function c32013448.thcon(e,tp,eg,ep,ev,re,r,rp)
	...
	--return eg:IsExists(c32013448.cfilter,1,nil,e,tp)
...
function c32013448.condition(e,tp,eg,ep,ev,re,r,rp)
	return r==REASON_RITUAL
end
function c32013448.operation(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local rc=eg:GetFirst()
	while rc do
		if rc:GetFlagEffect(32013448)==0 then
			--Banish monster
			local e1=Effect.CreateEffect(c)
			...
			e1:SetCountLimit(1)
			e1:SetTarget(c32013448.rmtg1)
			e1:SetOperation(c32013448.rmop1)
			...
			rc:RegisterFlagEffect(32013448,RESET_EVENT+0x1fe0000,0,1)
		end
		rc=eg:GetNext()
	end
end
function c32013448.rmtg1(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c32013448.rmop1(e,tp,eg,ep,ev,re,r,rp)
