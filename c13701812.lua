...
function c13701812.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(13701812,0))
...
function c13701812.target0(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	and	Duel.SelectYesNo(tp,aux.Stringid(13701812,0)) then 
...
function c13701812.condition(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsPreviousLocation(LOCATION_ONFIELD) and e:GetLabel()==1
end
